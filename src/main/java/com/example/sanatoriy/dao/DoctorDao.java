...
public class DoctorDao {
    ...
    public boolean registerDoctor(Doctor d) {
        ...
        try {
            String sql = "insert into doctor(full_name,dob,qualification,specialization,email,mobno,password,spec_id) values(?,?,?,?,?,?,?,?)";
            ...
            ps.setInt(8, getSpecialistIdByName(d.getSpecialist()));
